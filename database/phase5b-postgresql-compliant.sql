-- ✅ PHASE 5B: POSTGRESQL-COMPLIANT DEPLOYMENT SCRIPT
-- 🎯 Fixed: IF NOT EXISTS syntax issues for policies
-- 📋 Run this script in your Supabase SQL editor

-- =============================================================================
-- PART 1: ENHANCED CHAT TABLES (Phase 5B) - FIXED SYNTAX
-- =============================================================================
...
-- Step 4: Create RLS policy for UI assets (FIXED: No IF NOT EXISTS for policies)
DROP POLICY IF EXISTS chat_ui_assets_contractor_access ON chat_message_ui_assets;
...
-- Step 7: Create RLS policy for typing indicators (FIXED: No IF NOT EXISTS for policies)
DROP POLICY IF EXISTS chat_typing_contractor_access ON chat_typing_indicators;
...
-- Step 11: Create RLS policy for follow-up prompts (FIXED: No IF NOT EXISTS for policies)
DROP POLICY IF EXISTS chat_prompts_contractor_access ON chat_followup_prompts;
...
-- =============================================================================
-- PART 2: ENHANCED CHAT FUNCTIONS (Phase 5B) - POSTGRESQL COMPLIANT
-- =============================================================================
...
-- ✅ POSTGRESQL SYNTAX COMPLIANT DEPLOYMENT SCRIPT
-- 📋 Fixed: All policy creation uses DROP IF EXISTS + CREATE pattern
-- 🚀 Ready for production deployment without syntax errors
