-- =====================================
-- FIX: Remove Duplicate Function Issue
-- =====================================

-- Drop all versions of the function first
DROP FUNCTION IF EXISTS ensure_contractor_profile(uuid, text);
DROP FUNCTION IF EXISTS ensure_contractor_profile(uuid);
DROP FUNCTION IF EXISTS ensure_contractor_profile(text);
